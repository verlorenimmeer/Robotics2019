# -*- coding: utf-8 -*-
"""
Created on Fri Mar 22 15:33:37 2019
...
def stepper(space,swing,robot_u,seat_motor,knee_motor,l_leg,u_leg,action):
    ...
    pos = swing.position
    moment_inertia=swing.moment
    angular_vel=robot_u.angular_velocity
    Kinetic_en=robot_u.kinetic_energy+swing.kinetic_energy
    angle= swing.angle
    
    return [pos[0],pos[1],vel[0],vel[1],swing.mass,moment_inertia,angular_vel,Kinetic_en,angle],[space,swing,robot_u,seat_motor,knee_motor,l_leg,u_leg]
...
#    
    ...
    vel = swing.velocity
    pos = swing.position
    moment_inertia=robot_u.moment
    angular_vel=swing.angular_velocity
    Kinetic_en=robot_u.kinetic_energy+swing.kinetic_energy
    angle= swing.angle
    
    return [pos[0],pos[1],vel[0],vel[1],swing.mass,moment_inertia,angular_vel,Kinetic_en,angle],[space,swing,robot_u,seat_motor,knee_motor,l_leg,u_leg,screen,draw_options,clock,font]
