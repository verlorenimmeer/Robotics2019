# -*- coding: utf-8 -*-
"""
Created on Thu Mar 28 10:43:33 2019
...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar 18 13:31:04 2019
...
class QLearn:
    def __init__(self, actions, epsilon=0.1, alpha=0.2, gamma=0.7):
        #print(len(actions))
        self.q = [[0,0,0,0] for i in range(720) ] 
